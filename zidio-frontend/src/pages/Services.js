...
const Services = () => {
  return (
    <div className="flex flex-col items-center bg-gradient-to-br from-[#c79f42] via-[#079c37] to-[#1eb5cc]">
      <div className="p-10 rounded-2xl shadow-lg max-w-4xl w-full">
        <h1 className="text-3xl font-bold text-center text-indigo-600 mb-6">Our Services</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md group relative h-40 overflow-hidden transition-all duration-300 hover:h-64">
            <h2 className="text-2xl font-semibold text-center text-red-600 mb-3">Task Management</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md group relative h-40 overflow-hidden transition-all duration-300 hover:h-64">
            <h2 className="text-2xl font-semibold text-center text-red-600 mb-3">Project Planning</h2>
            <div className="flex justify-center mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md group relative h-40 overflow-hidden transition-all duration-300 hover:h-64">
            <h2 className="text-2xl font-semibold text-center text-red-600 mb-3">Team Collaboration</h2>
            <div className="flex justify-center mb-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md group relative h-40 overflow-hidden transition-all duration-300 hover:h-64">
            <h2 className="text-2xl font-semibold text-center text-red-600 mb-3">Analytics & Reporting</h2>
            <div className="flex justify-center mb-4">
