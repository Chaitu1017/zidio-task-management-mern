...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-red-500 to-green-600 flex flex-col items-center justify-center text-black px-4">
      {/* Hero Section */}
      <motion.h1
      ...
      >
        <Link to="/register">
          <motion.button
            className="px-6 py-3 bg-white text-green-600 font-bold rounded-lg shadow-lg hover:bg-gray-200"
