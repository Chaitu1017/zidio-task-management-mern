    ...
    <div className="flex flex-col bg-darkBg min-h-screen text-white font-sans">
      <main className="flex-1 p-6 overflow-y-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-6">
          {/* Task Priority Chart */}
          <div className="bg-rose-200 p-4 rounded-2xl shadow-glass border border-white/10">
          ...
          {/* Real-Time Chart */}
          <div className="bg-pink-500 p-4 rounded-2xl shadow-glass border border-blue-400/10">
            <h2 className="text-xl font-semibold mb-4">
          ...
          {/* Overdue Task Chart */}
          <div className="bg-green-500 p-4 rounded-2xl shadow-glass border border-white/10">
