  ...
  return (
    <div className="flex bg-gradient-to-br from-[#042330] via-[#214753] to-[#06041e] min-h-screen font-sans bg-white dark:bg-gray-900 text-black dark:text-white">
      <main className="flex-1 p-6 overflow-y-auto space-y-6">
        ...
        >
          <div className="bg-gradient-to-br from-red-600 via-purple-900 to-pink-800 p-4 rounded-xl shadow-lg flex items-center justify-center overflow-hidden">
            <div className="w-full h-full max-w-full max-h-full">
              <TaskPriorityChart tasks={tasks} />
            </div>
          </div>

          <div className="bg-gradient-to-br from-purple-400 via-blue-400 to-green-400 p-4 rounded-xl shadow-lg flex items-center justify-center overflow-hidden">
            <div className="w-full h-full max-w-full max-h-full">
              <RealtimeChart tasks={tasks} />
            </div>
          </div>

          <div className="col-span-2 md:col-span-2 gap-2 bg-gradient-to-br from-yellow-600 via-pink-600 to-rose-500 p-4 rounded-xl shadow-lg flex items-center justify-center overflow-auto">
            <div className="">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 mt-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-white px-4 py-2 rounded-lg shadow-md hover:scale-105 transition"
            >
              Export CSV
            </button>
            <button
